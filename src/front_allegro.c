...
typedef struct {
    ...
    ALLEGRO_BITMAP* ship;
    ALLEGRO_BITMAP* aliens[3][11][2]; //3 tipos de aliens, 11 colores, 2 estados de animacion
    ALLEGRO_BITMAP* aliens_explotion[11]; //11 colores de explosiones
...
//    al_draw_filled_rectangle(aliens_get_x(i,j), aliens_get_y(i,j), aliens_get_x(i,j)+ALIENS_W, aliens_get_y(i,j)+ALIENS_H, al_map_rgb(255, 0, 0));
    if(i == 0){
        al_draw_bitmap(sprites.aliens[2][0][aliensframe], aliens_get_x(i,j), aliens_get_y(i,j), 0);
    }
    else if(i == 1 || i == 2){
        al_draw_bitmap(sprites.aliens[1][0][aliensframe], aliens_get_x(i,j), aliens_get_y(i,j), 0);
    }
    else{
        al_draw_bitmap(sprites.aliens[0][0][aliensframe], aliens_get_x(i,j), aliens_get_y(i,j), 0);
    }
//    al_draw_scaled_bitmap(sprites.aliens[0], 0, 0, 39, 26, aliens_get_x(i,j), aliens_get_y(i,j), 25, 20, 0);
}
...
static void sprites_init(){
    ...
    sprites.aliens[0][0][0] = sprite_grab(25-5, 24-5, 37+10, 26+10);
    sprites.aliens[0][0][1] = sprite_grab(108, 24, 39, 27);
    sprites.aliens[1][0][0] = sprite_grab(194-10, 27-8, 34+20, 23+18);
    sprites.aliens[1][0][1] = sprite_grab(279-2, 27, 32+5, 24);
    sprites.aliens[2][0][0] = sprite_grab(363-8, 26-10, 25+16, 24+25);
    sprites.aliens[2][0][1] = sprite_grab(363+85-15, 26-10, 25+16, 24+25);
}

static void sprites_deinit(){

    al_destroy_bitmap(sprites.aliens[0][0][0]);
    al_destroy_bitmap(sprites.aliens[0][0][1]);
    al_destroy_bitmap(sprites.aliens[1][0][0]);
    al_destroy_bitmap(sprites.aliens[1][0][1]);
    al_destroy_bitmap(sprites.aliens[2][0][0]);
    al_destroy_bitmap(sprites.aliens[2][0][1]);
